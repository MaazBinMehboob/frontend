...
const AppointmentForm = () => {
  ...
  const { data: doctorData, isLoading: doctorsLoading, isError: doctorsError } = useGetDoctorsQuery();
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                required
                className="w-full px-3 py-2 border border-blue-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-white disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed"
              >
                <option value="">
                  {doctorsLoading ? "Loading doctors..." : doctorsError ? "Error loading doctors" : "Choose a doctor..."}
                </option>
                {doctorsError ? (
                  <option value="" disabled>Failed to fetch doctors</option>
                ) : (
              ...
              {doctorsError && (
                <div className="mt-2 flex items-center gap-2 text-red-600 text-sm">
                  ...
                  <span>Unable to load doctor list. Please try again.</span>
                </div>
              )}
            </div>
          </div>
